...
/* Здесь настройки камеры и разрешения экрана*/
...
final class CameraConfigurationManager {
  ...
  private static final int MIN_PREVIEW_PIXELS = 470 * 320; // минимальное разрешение
  private static final int MAX_PREVIEW_PIXELS = 800 * 600; // максимальное разрешение
  ...
  /*
  Один раз считывает параметры камеры, необходимые приложению
   */
